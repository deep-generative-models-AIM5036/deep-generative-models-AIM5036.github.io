...
latent p(z)는 categorical distribution이라서 latent z를 feature map으로 하여 autoregressive 모델을 만들 수 있습니다.
그래서 학습된 TVQ-VAE의  latent z를 condition으로 하여 PixelCNN이 이미지를 생성하도록 할 수 있습니다.   
