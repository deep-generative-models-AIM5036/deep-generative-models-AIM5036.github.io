...
에 대한 일차 편미분(∂)을 행렬로 나타낸 것입니다. 이를 나타내면 다음과 같습니다.
    ...
    <p align="center"><img src="/Glow_img/jacobian.png",  height="150px", width="350px"></p>
...
2. 행렬식(Determinant)은 정방행렬(n x n matrix)에 스칼라를 대응하는 함수의 하나이고 다시 말하면  행렬을 대표하는 하나의 스칼라로 계산한다는 것
    ...
    <p align="center"><img src="/Glow_img/jacobian2.png", height="150px", width="350px"></p>
    
    또는 

    <p align="center"><img src="/Glow_img/jacobian3.png",  height="150px", width="350px"></p>
